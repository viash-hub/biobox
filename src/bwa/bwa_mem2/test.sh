...
bwa-mem2 index "$test_data_dir/index/reference.fasta" >/dev/null 2>&1

# Verify index was created
index_files=(
  "$test_data_dir/index/reference.fasta"
  "$test_data_dir/index/reference.fasta.0123"
  "$test_data_dir/index/reference.fasta.amb"
  "$test_data_dir/index/reference.fasta.ann"
  "$test_data_dir/index/reference.fasta.bwt.2bit.64"
