...
"$meta_executable" \
    --paired \
    --input "$test_dir/scrb_seq_fastq.1.gz","$test_dir/scrb_seq_fastq.2.gz" \
...
gunzip -c scrb_seq_fastq.1.umi_extract.fastq.gz > scrb_seq_fastq.1.umi_extract.fastq
cat scrb_seq_fastq.1.umi_extract.fastq
...
diff -q <(gunzip -c "${meta_resources_dir}/scrb_seq_fastq.2.umi_extract.fastq.gz"z) <(gunzip -c "$test_dir/scrb_seq_fastq.2.umi_extract.fastq.gz") || \
